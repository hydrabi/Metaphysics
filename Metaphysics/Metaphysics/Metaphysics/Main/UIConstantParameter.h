...
//十五运
static const CGFloat daYunSubTableViewWidth = 140.0f;
...
static const CGFloat daYunSubTableCellHeight = (daYunSubTableViewWidth-daYunSubTitleViewHeight - daYunSubTableViewMiddleOffset) / daYunSubTableViewCount;
