...
-(void)UIConfig{
    ...
    self.horLine2Label.font = [UIFont systemFontOfSize:titleFontSize_30];
    self.horLine3Label.font = [UIFont systemFontOfSize:titleFontSize_30];
    self.verLineLabel.font = [UIFont systemFontOfSize:titleFontSize_30];
